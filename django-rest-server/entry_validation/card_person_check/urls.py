...
from .views import ApproveAccessRightRequestView, CheckCardPersonView, login_view, SecurityZoneListView, EmployeeListView,AccessRightRequestView, AccessRightRequestListView, RegisterEmployee, MessageListView
